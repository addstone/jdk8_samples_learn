...
/**
 * Description:  Simple draggable area for the bottom right of a window to support resizing.
 * Description:  简单的拖拽区域支持调整窗口的右下角。
 * Author: LuDaShi
 * Date: 2020-12-31-15:18
 * UpdateDate: 2020-12-31-15:18
 * FileName: WindowResizeButton
 * Version: 0.0.0.1
 * Since: 0.0.0.1
 */
