...
/**
 * Description:  PropertySheet for editing groups of bean properties
 * Author: LuDaShi
 * Date: 2021-01-05-16:22
 * UpdateDate: 2021-01-05-16:22
 * FileName: PropertySheet
 * Version: 0.0.0.1
 * Since: 0.0.0.1
 */
...
public class PropertySheet extends Accordion {
    ...
    public PropertySheet(PropertyGroup... propertyGroups) {
        ...
        if (propertyGroups.length > 0) {
            getPanes().get(0).setExpanded(true);
        }
