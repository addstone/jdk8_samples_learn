...
/**
 * Description:   * Base class for all Ensemble samples. Samples can either support layout resizing or they can be fixed size if needed
 *  * for simple graphics etc. If you need fixed size use the constructor with width and height arguments.
 * Author: LuDaShi
 * Date: 2021-01-05-14:00
 * UpdateDate: 2021-01-05-14:00
 * FileName: Sample
 * Version: 0.0.0.1
 * Since: 0.0.0.1
 */
